...
# yield_curve data
yields <- read_csv("../../data/ecb_yields.csv")
...
#===============================================================================
# Analyze the relationship between the yields and mpu controling for level shocks
#===============================================================================
...
ggsave(filename = "../../figures/yield_responses_ECB.png", plot = p.all)

p1
ggsave(filename = "../../figures/yield_responses_ECB1.png", plot = p1)
...
p.all <- gridExtra::grid.arrange(p1, p2, p3, p4)
ggsave(filename = "../../figures/yield_responses_ECB_ed_shock.png", plot = p.all)

p1
ggsave(filename = "../../figures/yield_responses_ECB1_ed_shock.png", plot = p1)
